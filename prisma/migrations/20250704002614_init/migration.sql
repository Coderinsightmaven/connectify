...
-- CreateIndex
CREATE UNIQUE INDEX "video_chat_sessions_sessionId_key" ON "video_chat_sessions"("sessionId");
...
-- AddForeignKey
ALTER TABLE "chat_messages" ADD CONSTRAINT "chat_messages_sessionId_fkey" FOREIGN KEY ("sessionId") REFERENCES "video_chat_sessions"("id") ON DELETE CASCADE ON UPDATE CASCADE;
